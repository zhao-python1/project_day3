        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="course in course_list">
                <el-row>
                    ...
                    <el-col :span="10" class="course-info">
                        ...
                        <span class="discount">{{course.discount_name}}</span></span>
            ...
            <div class="calc">
                <el-row class="pay-row">
                    ...
                    <el-col :span="4" class="cart-pay" ><span @click="pay_for">支付宝支付</span></el-col>
                </el-row>
            </div>
        </div>
        <Footer/>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                course_list:[],
                total_price:0, //没有优惠的总价
                real_price:0, //优惠后的总价
            }
        },
        created(){
            this.token = this.user_login()
            this.get_select()
        },
        methods:{
            user_login(){
            ...
            get_select(){
                this.$axios({
                    url:this.$settings.HOST+'shop/settlement/',
                    method:'get',
                    headers:{
                    ...
                    this.real_price = response.data.total_price;
                }).catch(error=>{
          ...
          // 订单页面
            pay_for(){
                this.$axios({
                    url:this.$settings.HOST+'sel/sell/',
                    method: 'post',
                    data:{
                        "pay_type":"1"
                    },
                    ...
                    this.$message.success("恭喜订单成功，返回购物车")
